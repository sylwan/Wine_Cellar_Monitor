...
def parser(unparsed_args):
  ...
  #following is helpful when a device may be deepsleeping for a while - SS 10-16-2020
  ...
  group.add_option("-y", "--retries",
    dest = "retries",
    type = "int",
    help = "Retries of invitation to  ESP8266 to establish a connection (each retry will wait until timeout)",
    default = 10
  )
  parser.add_option_group(group)
